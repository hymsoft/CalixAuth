...
export const SettingsMenu = () => {
  ...
  const handleRateUs = () => {
    Alert.alert(t("settings.rate_title"), t("settings.rate_message"), [
      {
        text: "OK",
  ...
  const handleBuyCoffee = () => {
    Alert.alert(t("settings.donation_title"), t("settings.donation_message"), [
      {
        text: "OK",
        onPress: () => Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success),
      },
          ...
          <View style={[styles.modal, { backgroundColor: colors.surface }]}>
            ...
            {viewMode === "main" ? (
              <View style={styles.menuList}>
                <TouchableOpacity style={styles.menuItem} onPress={() => setViewMode("languages")}>
                  <Text style={styles.itemIcon}>🌐</Text>
                  <Text style={[styles.itemText, { color: colors.text.main }]}>
                    {t("common.language")}
                  </Text>
                  <Text style={styles.currentValueLabel}>{currentLang?.toUpperCase() || ""}</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.menuItem} onPress={() => setViewMode("themes")}>
                  <Text style={styles.itemIcon}>🌓</Text>
                  <Text style={[styles.itemText, { color: colors.text.main }]}>
                    {t("settings.theme")}
                  </Text>
                  <Text style={styles.currentValueLabel}>{t(`settings.theme_${theme}`)}</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity style={styles.aboutLink} onPress={() => setViewMode("about")}>
              ...
              <View style={styles.aboutContainer}>
                ...
                <View style={styles.aboutInfo}>
                  ...
                  <Text style={[styles.aboutValue, { color: colors.text.main }]}>
                    Hugo Antonio Segura
                  </Text>
                </View>
                ...
                <View style={styles.aboutInfo}>
                  ...
                  <Text
                    style={[styles.aboutValue, { color: colors.text.main, fontStyle: "italic" }]}
                  >
                ...
                <View style={styles.legalLinksContainer}>
                  <TouchableOpacity
                    onPress={() =>
                      Linking.openURL("https://github.com/hymsoft/CalixAuth/blob/main/PRIVACY.md")
                    }
                  >
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      Linking.openURL("https://github.com/hymsoft/CalixAuth/blob/main/TERMS.md")
                    }
                  >
                    <Text style={[styles.legalLink, { color: colors.primary }]}>
              ...
              <View style={styles.menuList}>
                {languages.map((lang) => (
                  ...
                  >
                    ...
                    <Text style={[styles.text, { color: colors.text.main }]}>{lang.name}</Text>
                    {currentLang === lang.code && (
